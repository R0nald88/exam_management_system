...
public class TeacherExamManagementController implements Initializable {
    ...
    /**
     * Clear all selection in table showing all questions in the exam.
     * Disable "Delete from Left" button in the table
     * @author Cheung Tuen King
     */
    ...
    /**
     * Clear all selection in question table.
     * Disable "Add to Left" button in the table
     * @author Cheung Tuen King
     */
    ...
    /**
     * Add all the question from the question table to the table showing all question in the exam.
     * After successful adding, the question table and the table showing all question in the exam are refreshed.
     * The question table is cleared and table showing all question in the exam contains all question.
     * If any error occurred, the operation is terminated with error message dialog prompted.
     * This method is called when "Add All Question" button is clicked
     * @author Chueng Tuen King
     */
    ...
    /**
     * Delete all the question table showing all question in the exam.
     * After successful deletion, the question table and the table showing all question in the exam are refreshed.
     * The table showing all question in the exam is cleared and question table contains all question.
     * If any error occurred, the operation is terminated with error message dialog prompted.
     * This method is called when "Delete All Question" button is clicked
     * @author Chueng Tuen King
     */
